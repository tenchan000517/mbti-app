...
const industries: Record<string, IndustryMeta> = {
  manufacturing: {
    slug: 'manufacturing',
    label: '製造業',
    image: 'https://yumesuta.com/img/career-guide/manufacturing.png',
  ...
  construction: {
    slug: 'construction',
    label: '建設業',
    image: 'https://yumesuta.com/img/career-guide/construction.png',
  ...
  it: {
    slug: 'it',
    label: 'IT・情報',
    image: 'https://yumesuta.com/img/career-guide/it.png',
  ...
  retail: {
    slug: 'retail',
    label: 'サービス・小売',
    image: 'https://yumesuta.com/img/career-guide/retail.png',
  ...
  medical: {
    slug: 'medical',
    label: '医療・福祉',
    image: 'https://yumesuta.com/img/career-guide/medical.png',
  ...
  beauty: {
    slug: 'beauty',
    label: '美容・クリエイティブ',
    image: 'https://yumesuta.com/img/career-guide/beauty.png',
